...
export default {
    command: 'تيكه',
    aliases: ['technology', 'techimg', 'tech'],
    category: 'images',
    description: 'جلب ا عشوائي تيكه صورة',
    usage: '.تيكه',
    async handler(sock, message, args, context) {
        const chatId = context.chatId || message.key.remoteJid;
        try {
            const res = await axios.get('https://raw.githubusercontent.com/CrazySeif/Database/main/images/tech.json');
            ...
            await sock.sendMessage(chatId, { image: { url: randomImage }, caption: 'ðŸ’» Tech Image' }, { quoted: message });
        }
        catch (err) {
