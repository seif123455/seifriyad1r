...
export default {
    command: 'Ø°ÙƒØ§Ø¡',
    aliases: ['llama', 'ai', 'chat', 'ask', 'Ø§Ø³Ø§Ù„', 'Ø³Ø¤Ø§Ù„', 'gpt'],
        ...
        if (!Ø§Ù„Ø³Ø¤Ø§Ù„) {
            return sock.sendMessage(chatId, { 
                text: `ðŸ¤– *Ù…Ø³Ø§Ø¹Ø¯ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ*\n\n` +
                    `*Ø§Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù…:* \`${prefix}Ø°ÙƒØ§Ø¡ <Ø³Ø¤Ø§Ù„Ùƒ>\`\n\n` +
                    `*Ø£Ù…Ø«Ù„Ø©:*\n` +
                    `â€¢ \`${prefix}Ø°ÙƒØ§Ø¡ Ù…Ø§ Ù‡ÙŠ Ø¹Ø§ØµÙ…Ø© Ù…ØµØ±ØŸ\`\n` +
                    `â€¢ \`${prefix}Ø°ÙƒØ§Ø¡ Ø§Ø´Ø±Ø­ Ù„ÙŠ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ\`\n` +
                    `â€¢ \`${prefix}Ø°ÙƒØ§Ø¡ ÙƒÙ… Ø¹Ù…Ø±ÙƒØŸ\``
            }, { quoted: message });
        }
